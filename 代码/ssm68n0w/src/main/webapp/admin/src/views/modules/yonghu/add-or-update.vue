<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="qq" prop="qq">
          <el-input v-model="ruleForm.qq" 
              placeholder="qq" clearable  :readonly="ro.qq"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="qq" prop="qq">
              <el-input v-model="ruleForm.qq" 
                placeholder="qq" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
